...
-- 11. AJOUT DE LA FONCTION DE CRÉATION DE PROFIL SÉCURISÉE (MANQUANTE)
-- On supprime les anciennes versions au cas où pour éviter les conflits
DROP FUNCTION IF EXISTS public.create_profile_safe(UUID,TEXT,TEXT,TEXT,TEXT,TEXT,TEXT,TEXT,TEXT,TEXT,relationship_type,TEXT,TEXT,BOOLEAN,DATE,family_title,TEXT,BOOLEAN);
DROP FUNCTION IF EXISTS public.create_profile_safe(UUID, UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, public.relationship_type, TEXT, TEXT, BOOLEAN, DATE, public.family_title, TEXT, BOOLEAN);

-- On crée la fonction avec la bonne signature (incluant p_user_id) et la logique pour désactiver le trigger
...
BEGIN
    -- On désactive le trigger qui lie automatiquement à un arbre
    -- car le profil n'est pas encore totalement configuré.
    ...
    -- On réactive le trigger après l'insertion
...
EXCEPTION
    WHEN OTHERS THEN
        -- S'il y a une erreur, on s'assure de réactiver le trigger
        ALTER TABLE public.profiles ENABLE TRIGGER trigger_new_profile;
        RETURN json_build_object(
            'success', false,
            'error', SQLERRM
...
-- On donne les permissions pour la nouvelle fonction
